...
window.Modernizr = function(e, t, n) {
        ...
        return c.addTest = function(e, t) {
            ...
            function(e, t) {
                ...
                e.html5 = y, a(t)
            }(this, t), c._version = l, c._domPrefixes = E, c._cssomPrefixes = w, c.testProp = function(e) {
                return u([e])
            }, c.testAllProps = f, c.prefixed = function(e, t, n) {
                return t ? f(e, t, n) : f(e, "pfx")
            }, p.className = p.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (h ? " js " + N.join(" ") : ""), c
    }(this, this.document),
    function(e, t, n) {
        function r(e) {
...
(function(e) {
    ...
    var t = {
        ...
        n = t[Modernizr.prefixed("transition")],
        r = {
    ...
    s.prototype._initEvents = function() {
        var e = this,
            t = this.questions[this.current].querySelector("input"),
            n = function() {
                t.removeEventListener("focus", n);
                classie.addClass(e.ctrlNext, "show")
            };
        t.addEventListener("focus", n);
        this.ctrlNext.addEventListener("click", function(t) {
            t.preventDefault();
            e._nextQuestion()
        });
    ...
    s.prototype._nextQuestion = function() {
        ...
        if (this.supportsHTML5Forms) {
            var e = this.questions[this.current].querySelector("input");
            e.setCustomValidity("");
            if (!e.checkValidity()) {
                e.setCustomValidity("Whoops, that's not an email address!");
                this._showError(e.validationMessage);
                return false
            }
        }
        ...
        if (!this.isFilled) {
            ...
            var i = this.questions[this.current];
            classie.removeClass(t, "current");
        ...
        var s = this,
            o = function(e) {
                ...
                if (s.isFilled) {
                    ...
                    classie.removeClass(s.el, "show-next");
                    s.currentNum.innerHTML = s.nextQuestionNum.innerHTML;
                    s.questionStatus.removeChild(s.nextQuestionNum);
                    i.querySelector("input").focus()
                }
            };
        if (r.transitions) {
            this.progress.addEventListener(n, o)
        } else {
            o()
        }
    };
    ...
    s.prototype._validate = function() {
        var e = this.questions[this.current].querySelector("input").value;
        if (e === "") {
    ...
    s.prototype._showError = function(e) {
        var t = "";
        switch (e) {
            case "EMPTYSTR":
                t = "Please fill the field before continuing";
                break;
            case "INVALIDEMAIL":
                t = "Please fill a valid email address";
                break;
            default:
                t = e
        }
